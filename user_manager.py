...
class UserManager(ModelManager):
    ...
    def login_user(self, entered_username, entered_password):
        user_obj = self.get('username', entered_username)
        if user_obj:
            if user_obj.check_password(entered_password):
                return user_obj
        print("no username ")
    ...
    def register_user(self, entered_username, entered_password):
        ...
        res = self.get('username', entered_username)
        if res :
        ...
        new_user = User(entered_username) 
        new_user.password = entered_password ### class setter method ( call hash method)
